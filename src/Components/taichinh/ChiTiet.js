            ...
            <Text style={styles.topOfMobi}> </Text>
                <View style={[styles.pageTitle]}>
                    <TouchableOpacity style={styles.flexR}  onPress={() => navigation.goBack()} href="../home.html">
                        ...
                        <Text style={styles.textTitle}> Danh sách {route.params.TEN}</Text>
                    </TouchableOpacity>
                </View>
                ...
                {dtKhoan.map((item, index) =>  (
                    <View key={index}>
                        <View style={[styles.flex, styles.fs15, styles.px15, styles.py7, styles.mt7, styles.itemCenter, styles.flexR]}>
                            ...
                            <Text style={[styles.color66, styles.flexShrink0, styles.w1/4, styles.mr20, styles.block, styles.lineHeight20, styles.fs15, styles.fwBold]}> Số phiếu</Text>
                            <Text style={[styles.colorRaw, styles.mlAuto, styles.textRight, styles.lineHeight20, styles.fwBold, styles.fs15]}>{item.SOPHIEUTHU}</Text>
                        </View>
                        ...
                        <View style={[styles.flex, styles.fs15, styles.px15, styles.py7, styles.mt7, styles.flexR]}>
                            <Text style={[styles.color66, styles.mr20, styles.block, styles.lineHeight20, styles.fs15]}>Tổng tiền </Text>
                            <Text style={[styles.colorRaw, styles.mlAuto, styles.textRight, styles.lineHeight20, styles.fs15]}>{Core.formatCurrency(item.TONGTIEN)}</Text>
                        </View>
                        <View style={[styles.line1, styles.bgE9, styles.mt7]}></View>
                        <View style={[styles.flex, styles.fs15, styles.px15, styles.py7, styles.mt7, styles.flexR]}>
                            <Text style={[styles.color66, styles.mr20, styles.block, styles.lineHeight20, styles.fs15]}>Ngày thu </Text>
                            <Text style={[styles.colorRaw, styles.mlAuto, styles.textRight, styles.lineHeight20, styles.fs15]}>{item.NGAYTHU_DD_MM_YYYY_HHMMSS}</Text>
                        </View>
                        <View style={[styles.line1, styles.bgE9, styles.mt7]}></View>
                        <View style={[styles.flex, styles.fs15, styles.px15, styles.py7, styles.mt7, styles.flexR]}>
                            <Text style={[styles.color66, styles.mr20, styles.block, styles.lineHeight20, styles.fs15]}>Người tạo</Text>
                            <Text style={[styles.colorRaw, styles.mlAuto, styles.textRight, styles.lineHeight20, styles.fs15]}>{item.TAIKHOAN_NGUOITHU}</Text>
                        </View>
